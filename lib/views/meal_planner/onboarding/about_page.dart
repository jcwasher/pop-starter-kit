...
@RoutePage()
class MealPlannerAboutPage extends StatefulHookWidget {
  const MealPlannerAboutPage({super.key});

  @override
  State<MealPlannerAboutPage> createState() => _MealPlannerAboutPageState();
}

class _MealPlannerAboutPageState extends State<MealPlannerAboutPage>
