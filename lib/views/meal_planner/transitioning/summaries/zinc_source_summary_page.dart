...
class MealPlannerZincSourceSummaryPage extends StatelessWidget {
  const MealPlannerZincSourceSummaryPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return TransitionSummaryBasePage(
      children: [
        ...
        RedTextSpan(
          text:
              '${mealPlannerController.zincSourceAmount.toStringAsFixed(3)}g of ${zincSource!.description}',
        ),
        TextSpan(text: '.'),
