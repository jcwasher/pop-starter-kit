...
class MealPlannerVitaminESourceIngredientsPage extends HookWidget {
  const MealPlannerVitaminESourceIngredientsPage({super.key});
                    ...
                    items: VitaminESource.values
                        .map((vitaminESource) =>
                            DropdownMenuItem<VitaminESource>(
                              value: vitaminESource,
                              child: Text(vitaminESource.description),
                            ))
                        .toList(),
